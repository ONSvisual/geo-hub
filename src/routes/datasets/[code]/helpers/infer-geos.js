export const groups = [
	{key: "uk", label: "United Kingdom", codes: ["K02"]},
	// {key: "gb", label: "Great Britain", codes: ["K03"]},
	// {key: "ew", label: "England and Wales", codes: ["K04"]},
	{key: "ctry", label: "Countries", codes: ["E92", "N92", "S92", "W92"]},
	{key: "rgn", label: "Regions", codes: ["E12", "N92", "S92", "W92"]},
	{key: "cauth", label: "Combined authorities", codes: ["E47"]},
	{key: "utla", label: "Upper-tier local authorities", codes: ["E06", "E08", "E09", "E10", "N09", "S12", "W06"]},
	{key: "ltla", label: "Lower-tier local authorities", codes: ["E06", "E08", "E07", "E09", "N09", "S12", "W06"]},
];

export const groupsLookup = (() => {
	const lkp = {};
	for (const g of groups) lkp[g.key] = g;
	return lkp;
})();
...
export default function inferGeos(codes) {
