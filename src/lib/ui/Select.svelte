...
<div class="select-wrapper">
	<Select
		{id} {mode} options={items}
		bind:value bind:filterText
		{idKey} {labelKey} {groupKey}
		{placeholder} {label} {hideLabel}
		{multiple} {autoClear}
		{loadOptions} {itemFilter}
		on:change={handleSelect} on:input on:focus on:blur on:clear
